...
const companyData = {
    ...
    chatContacts: {
        unternehmen: {
            ...
            avatar: "KabelWerke",
            greeting: "Willkommen! Thomas Weber (Beschaffung & Logistik) und Sandra Keller (Finanzen & Controlling) sind für Sie da. Stellen Sie Fragen zum Materialeinkauf, zur Logistik, zur Bilanz oder zum Risikomanagement.",
            responses: [
        ...
        bank: {
            ...
            responses: [
                ...
                },
                {
                    ...
                    answer: "Handel: Quote accepted. Sammel-Rohwarentermingeschäft auf Kupfer, Asian Style (monatliches Settlement). Zeitraum: Februar 2027 bis inkl. Juli 2027, 200 mt/Monat. Terminpreis wird zur Zusage auf LME-Base gefixed in EUR. Konditionen: Risikolimitauslastung 20% (<1 Jahr) / 25% (>1 Jahr) -> Summe ca. 3.105.000 EUR."
                },
                {
                ...
                },
                {
                    ...
                    answer: "Handel: Quote accepted. EUA Forward (European Style). Lieferung Mitte Dezember 2026. Volumen: 20.000 Stück. Konditionen: Risikolinie 20% auf Nominal (ca. 296.000 EUR Limitbelastung bei 1.48 Mio. Nominal)."
                },
                {
                ...
                },
                {
                    ...
                    answer: "Handel: Quote accepted. Sammel-Rohwarentermingeschäft auf ICE Gasoil, Asian Style (monatliches Settlement), Juli 2026 bis inkl. Dezember 2026. 114 mt pro Monat. Terminkurs Einstand: 757 EUR/mt. Konditionen: Risikolinie 20% auf Nominal (Standard) -> ca. 103.500 EUR."
                }
            ],
