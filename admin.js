...
function renderGroupTabs() {
    ...
    for (let i = 1; i <= totalGroups; i++) {
        ...
        container.innerHTML += `<button class="btn" style="white-space: nowrap; font-size: 0.85rem; padding: 10px 18px; border-radius: 10px; font-weight: 700; ${activeStyle}" onclick="switchGroupContext('${name}')">${displayName}</button>`;
    }
}
